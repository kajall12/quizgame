...
function loadQuestion() {
  ...
  document.getElementById("nextBtn").style.display = "none"; // hide Next by default
}
...
function selectAnswer(btn, correct) {
  ...
  allBtns.forEach(b => b.disabled = true); // disable all options
